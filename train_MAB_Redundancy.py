...
# ── Phase 1: Entropy-only magnitude (no dual-signal) ──
...
def compute_redundancy(net, threshold=0.95):
    ...
    print('[Redundancy] Done. Max neighbors: {:.0f}, '
          'Samples with score>0.5: {}/{}'.format(max_count, n_redundant, n_train))
...
if __name__ == '__main__':
    print('=== Config G: EntAugment + MAB + Redundancy (no dual-signal, no EntLoss) ===')
    print('Redundancy: update_freq={}, threshold={}'.format(
        args.redundancy_update_freq, args.redundancy_threshold))
    print('UCB alpha: {}'.format(args.ucb_alpha))
    ...
    with open(result_file, 'a', newline='') as f:
        ...
        writer.writerow([args.dataset, cfg['model']['type'], args.seed, best_epoch, best_acc, 'config_G'])