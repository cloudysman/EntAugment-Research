...
def cutmix_data(inputs, labels, alpha=1.0):
    """Standard CutMix: random lambda from Beta distribution."""
...
def train(net, epoch):
    ...
    for i, data in enumerate(train_loader, 0):
        ...
        # EntAugment magnitude (same as original)
...
if __name__ == '__main__':
    print('=== H1: EntAugment + Standard CutMix ===')
    print('Seed: {}, cutmix_prob: {}, cutmix_alpha: {}'.format(
        args.seed, args.cutmix_prob, args.cutmix_alpha))
    ...
    with open(result_file, 'a', newline='') as f:
        ...
        writer.writerow([args.dataset, cfg['model']['type'], args.seed,
                         best_epoch, best_acc, 'EntAugment_CutMix'])
